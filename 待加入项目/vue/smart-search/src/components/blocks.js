      ...
      <ul {...data}>
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              <span domPropsInnerHTML={value} class={[CLASS_NAME_SUGGESTION_FIELD_ITEM_VALUE]} />
              {description ? (
                <span class="ai-common-suggestion-field-item__description">{description}</span>
              ) : null}
              {count ? (
                <span class="ai-common-suggestion-field-item__count">
                  <span>≈</span> {formatValue(count)}
                </span>
              ) : null}
            </SuggestionItem>
          )
      ...
      <ul {...data}>
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              <span domPropsInnerHTML={value} class="ai-common-suggestion-field-item__label" />
              <span class="ai-common-suggestion-field-item__description">{description}</span>
            </SuggestionItem>
          )
        })}
...
export { BlockFields, BlockSuggestion }
