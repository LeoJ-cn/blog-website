<template>
  <div
    class="ai-common-image-panel"
    v-show="imagePanelShow"
    v-if="imagePanelData.list.length > 0"
    @mouseup="endMove"
  >
    <div class="ai-common-image-panel__container">
      <div class="ai-common-image-panel__content" ref="imageContent">
        <div
          ...
          @mousemove="moveImage"
          @mousedown="startMove"
          class="ai-common-image-panel__move-content"
          id="imagePanelLazy"
        >
          <div
            :style="imageStyle"
            class="ai-common-image-panel__canvas"
            v-if="isUseCanvas && imageType === 'image'"
          >
            <ai-common-image-loader
              :item="imagePanelData.list[currentIndex].item"
              :key="currentIndex"
          ...
          <ai-common-lazy
            :key="currentIndex"
            class="ai-common-image-panel__lazy"
            :options="{ root: '#imagePanelLazy', delay: 0 }"
            :lazy-task="asyncload(imagePanelData.list[currentIndex])"
            v-if="!isUseCanvas || imageType !== 'image'"
          >
            <img
              class="ai-common-image-panel__image"
              :src="props.data"
              slot-scope="props"
              :style="imageStyle"
              draggable="false"
    ...
    <div class="ai-common-image-panel__banner" v-if="isStart">
      <div
        class="ai-common-image-panel__banner-content"
        :style="bannerStyle"
        id="imagePanelLazyBanner"
      >
        <div
          class="ai-common-image-panel__image-box"
    ...
    <div class="ai-common-image-panel__left" @click="toPrev" v-show="currentIndex > 0">
      <img src="./left.png" width="20" height="20" alt="" />
    </div>
    <div
      class="ai-common-image-panel__right"
      @click="toNext"
      v-show="currentIndex < imagePanelData.list.length - 1"
    >
      <img src="./right.png" width="20" height="20" alt="" />
    </div>
    <div class="ai-common-image-panel__close" @click="close">
      <img src="./cross.png" width="20" height="20" alt="" />
    </div>
    <div class="ai-common-image-panel__enlarge" @click="enlarge">
      <img src="./scale.png" width="20" height="20" alt="" />
    </div>
    <div class="ai-common-image-panel__narrow" @click="narrow">
      <img src="./scale1.png" width="20" height="20" alt="" />
    </div>
    <div class="ai-common-image-panel__scroll" @click="scroll">
      <img src="./scroll.png" width="20" height="20" alt="" />
    </div>
  </div>
</template>
