export const nodePropertiesBySyntaxKind = new Map([
  ...
  [
    'FunctionType | SyntaxKind.ConstructorType',
    new Set([
      'kind',
      'type',
      'flags',
  ...
  [
    'ClassExpression | SyntaxKind.ClassDeclaration',
    new Set([
      'kind',
      'name',
      'typeParameters',
  ...
  [
    'UnparsedText | SyntaxKind.UnparsedInternalText',
    new Set([
      'kind',
      'parent',
      'data',
  ...
  [
    ...
    new Set(['hasTrailingNewLine', 'kind', 'pos', 'end', 'text', 'hasLeadingNewline']),
  ],
  [
