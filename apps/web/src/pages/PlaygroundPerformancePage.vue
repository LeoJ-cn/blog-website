...
<template>
  <article class="playground-content">
    ...
    <h2>Performance</h2>
    <p class="playground-description">记录页面加载、运行时性能和资源表现。</p>
    ...
    <section v-if="activeTab === 'source'" class="tab-panel" role="tabpanel">
